                        ...
                        <form method="post">
                            <div className="row">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="acr-custom-select form-group">
                                        <label>Floor: </label>
                                        <Select2 data={floorlist} options={{
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="acr-custom-select form-group">
                                        <label>Sort by: </label>
                                        <Select2 data={sortbylist} options={{
                                            placeholder: 'Any',
                                        }} />
                                    </div>
                                </div>
                                ...
                                <div className="listing">
                                    <div className="listing-thumbnail">
                                        ...
                                        <div className="listing-controls">
                                            ...
                                            <Link to="#" className="fly-to-location" data-lat="-77.020945" data-lng="38.878241"><i className="fas fa-map-marker-alt" /></Link>
                                        </div>
                                    </div>
