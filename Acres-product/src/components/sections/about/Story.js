                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <img
                                ...
                                alt="Karibu Homes, Gigiri"
                            />
                        </div>
                        <div className="col-lg-6 mt-4 mt-lg-0">
                            <span className="karibu-eyebrow">Karibu means welcome</span>
                            <h2 className="title">We started because the first month is the hardest</h2>
                            <p>
                                Karibu began in 2019 in a Gigiri office, after watching too many
                            ...
                            <ul className="karibu-chips mt-3">
                                <li className="karibu-chip is-key"><i className="fas fa-check" />Every home visited in person</li>
                                <li className="karibu-chip is-key"><i className="fas fa-check" />Landlord pays our commission</li>
                                <li className="karibu-chip is-key"><i className="fas fa-check" />One consultant, start to finish</li>
                            </ul>
